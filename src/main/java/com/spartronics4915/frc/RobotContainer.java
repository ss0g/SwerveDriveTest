...
import com.spartronics4915.frc.commands.SwerveDriveCommands;
...
public class RobotContainer {
  private final XboxController mController = new XboxController(kControllerID);
  ...
  private final SwerveDriveSubsystem mSwerve = new SwerveDriveSubsystem();
  private final SwerveDriveCommands mSwerveDriveCommands = new SwerveDriveCommands(mSwerve, mController);

  private final Command mAutoCommand;

  /** The container for the robot. Contains subsystems, OI devices, and commands. */
  public RobotContainer() {
    mAutoCommand = mExampleCommand;
  ...
  public Command getTeleopCommand() {
    return mSwerveDriveCommands.new TeleopCommand();
  }
}
